...
pd.DataFrame(temp).to_csv('trader_joes_location.csv', sep=',', header=None, index=None)
...
# pd.DataFrame(temp).to_csv('nordstrom_location.csv', sep=',', header=None, index=None)
...
# pd.DataFrame(temp).to_csv('cabelas_location.csv', sep=',', header=None, index=None)
...
# pd.DataFrame(addresses).to_csv('cinemark_location.csv', sep=',', header=None, index=None)
